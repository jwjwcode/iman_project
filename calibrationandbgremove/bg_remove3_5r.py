...
INPUT_FOLDER = '/media/jing/GRDC-A/5-g Samples/Resonon Corrected one by one'
OUTPUT_FOLDER = '/media/jing/GRDC-A/5-g Samples/Resonon_bgremove'
FILEEXTENSION = '.bil'
